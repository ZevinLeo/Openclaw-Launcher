...
> **v1.10 版本已修复此问题**。我们强制将命令执行路径指向您的用户主目录，您现在可以在任何位置放心运行启动器。
...
> **A:** 请确保您使用的是 v1.10 及以上版本。新版本使用了底层的 `CREATE_NEW_CONSOLE` 技术，强制保持窗口可见，确保您能看到安装结果。
...
* ⚖️ **视觉平衡布局**：重写了安装向导的 Tab 样式，实现了标签页宽度的 **50/50 均分** 及 **粗体高亮**，极大提升了界面的平衡感与版本辨识度。
